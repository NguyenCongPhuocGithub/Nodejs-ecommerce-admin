...
const employeeSchema = new Schema(
    {
       ...
       firstName: {
        type: String,
        required: [true, 'Tên nhân viên chưa được nhập'],
        maxLength: [50, 'Tên không được vượt quá 50 ký tự'],
       },

        lastName: {
            type: String,
            required: [true, 'Họ nhân viên chưa được nhập'],
        ...
        phoneNumber: {
            ...
            validate: {
              validator: function (value) {
                ...
                console.log('<<=== valuePhoneNumber ===>>',`${value}: phoneNumber của nhân viên không hợp lệ`);
                return phoneRegex.test(value);
              },
              message: (props) => `${props.value}: giá trị phoneNumber của nhân viên không hợp lệ! `,
            },
        },
        address: {
            type: String,
        ...
        email: {
            ...
            validate: {
              ...
              message: (prop) => `${prop.value}: email không hợp lệ` ,
            },
...
employeeSchema.virtual('fullName').get(function () {
    ...
    console.log('<<=== fullName nhân viên ===>>', fullName);
    return fullName;
});
