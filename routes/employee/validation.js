...
const employeeSchema = yup.object({
    body: yup.object({
        firstName: yup.string().max(50, "Họ nhân viên quá dài").required("firstName: Họ nhân viên chưa được nhập"),

        lastName: yup.string().max(50, "Tên nhân viên quá dài").required("lastName: Tên nhân viên chưa được nhập"),
...
const employeePatchSchema = yup.object({
    body: yup.object({
      firstName: yup.string().max(50, "Họ nhân viên quá dài"),

      lastName: yup.string().max(50, "Tên nhân viên quá dài"),
